            ...
            return (
              ...
              >
                ...
                >
                  ...
                  />
                  {item.Quantity === 0 && (
                    <div className="absolute h-[30px] rounded-[32px] p-5 mx-[100px] flex items-center justify-center bg-black bg-opacity-50 text-white text-lg font-bold uppercase">
                      Out of stock
                    </div>
                  )}
                </div>
                ...
                <div className="flex flex-col items-center gap-[20px] py-[32px]">
                  ...
                  <button className={`bg-white text-[#01100b] rounded-lg py-[10px] px-[25px] w-[185px] font-semibold ${item.Quantity === 0 ? "bg-opacity-50" : "" }`}
